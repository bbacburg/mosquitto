...
Section "Files" SecInstall
	SectionIn RO
	SetOutPath "$INSTDIR"
	File "..\build64\x64-Release\src\mosquitto.exe"
	File "..\build64\x64-Release\apps\mosquitto_ctrl\mosquitto_ctrl.exe"
	File "..\build64\x64-Release\apps\mosquitto_passwd\mosquitto_passwd.exe"
	File "..\build64\x64-Release\client\mosquitto_pub.exe"
	File "..\build64\x64-Release\client\mosquitto_sub.exe"
	File "..\build64\x64-Release\client\mosquitto_rr.exe"
	File "..\build64\x64-Release\lib\mosquitto.dll"
	File "..\build64\x64-Release\lib\cpp\mosquittopp.dll"
	File "..\build64\x64-Release\plugins\dynamic-security\mosquitto_dynamic_security.dll"
	...
	File "..\build64\x64-Release\lib\mosquitto.lib"
	File "..\build64\x64-Release\lib\cpp\mosquittopp.lib"
